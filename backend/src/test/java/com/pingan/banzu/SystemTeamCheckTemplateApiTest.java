...
class SystemTeamCheckTemplateApiTest {
  ...
  @BeforeEach
  void cleanTemplatesCreatedByThisTestClass() {
    jdbcTemplate.update("delete from sys_team_check_template_item");
    jdbcTemplate.update("delete from sys_team_check_template");
    jdbcTemplate.update("delete from sys_check_item_library");
  }
