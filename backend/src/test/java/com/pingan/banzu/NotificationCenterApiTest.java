...
class NotificationCenterApiTest {
  ...
  void cleanNotifications() {
    jdbcTemplate.update("delete from biz_notification_recipient");
    jdbcTemplate.update("delete from biz_notification");
    jdbcTemplate.update("delete from biz_remind_record where biz_type = 'PRE_SHIFT_MEETING'");
    jdbcTemplate.update(
